...
#define XZ_CHAT_CONFIG_STRUCT struct { \
    ...
    char* lang; \
    xz_prot_type_t          prot_pref; \
    int send_buf_size; \
    capped_task_config_t        main_task_conf; \
    capped_task_config_t        read_audio_task_conf; \
    bool enable_realtime_listening; \
    xz_chat_audio_cb_t  audio_cb; \
    xz_chat_event_cb_t  event_cb;   \
    xz_chat_read_audio_cb_t read_audio_cb; \
}
...
/*
 ...
 if the job is successfully done, XZ_EVENT_STATE_CHANGED event will be fired and handled by event_cb.
*/
